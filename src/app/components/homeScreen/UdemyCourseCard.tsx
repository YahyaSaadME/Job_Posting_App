...
console.log(courses)
    return (
        <div className="p-3 mx-16 max-sm:mx-2 mt-8">
            ...
            <div className="pt-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    ...
    >
      <div className="flex gap-1 flex-wrap">
        {item.tags.map((cat: string, index: number) => (
          <span
            key={index}
            className="bg-pink-100 text-pink-600 text-sm font-semibold px-3 py-1 rounded-full mb-4 inline-block"
          >
            {cat}
          </span>
        ))}
  ...
  <Image
    src={
      "https://tse2.mm.bing.net/th?id=OIP.YoTUWMoKovQT0gCYOYMwzwHaHa&pid=Api&P=0&h=180"
    }
    alt="Author Avatar"
    width={40}
    height={40}
