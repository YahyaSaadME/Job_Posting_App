...
< ToastContainer />
      ...
      <div className="container mx-auto  flex justify-between  items-center h-16">
        ...
        <nav className="hidden md:flex items-center space-x-9">
          ...
          <Link href="/itreferral" className="text-gray-600 hover:text-gray-900">
            Employee IT Referral
          </Link>
        </nav>
        ...
        <Link href="#" className="text-gray-600 hover:text-gray-900">
              ...
              <Link href="#" className="text-gray-600 hover:text-gray-900">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                 ...
                 {/* WhatsApp */}
          <Link href="https://wa.me/1234567890" className="text-gray-600 hover:text-gray-900">
          ...
          {/* Telegram */}
          <Link href="https://telegram.me/yourusername" className="text-gray-600 hover:text-gray-900">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M21.572 2.02a1.482 1.482 0 0 0-1.601-.16L2.632 10.02a1.485 1.485 0 0 0-.648 1.74 1.495 1.495 0 0 0 .992.944l2.984.896 1.119 3.346c.125.374.462.646.853.688.04.003.08.004.12.004a.989.989 0 0 0 .894-.553l1.75-3.442 4.415 3.177c.273.195.605.3.945.3.104 0 .209-.009.314-.028a1.495 1.495 0 0 0 1.183-1.146l3.73-15.245a1.485 1.485 0 0 0-.449-1.44zM9.11 13.065l-2.273-.682 9.088-6.517-6.815 7.2z" />
            </svg>
          </Link>
      ...
      >
        ...
        <Link href="/jobs" className="block text-gray-600 hover:text-gray-900 mb-2">
          Jobs
        </Link>
        <Link href="/itreferral" className="block text-gray-600 hover:text-gray-900 mb-4">
          Employee IT Referral
        </Link>
