...
//             Blog
//           </a>
//           <a href="/free-courses" className="text-gray-600 hover:text-gray-900">
//              Free Course
//           </a>
    ...
    <header className="bg-white shadow-md fixed z-20 w-full  top-0 left-0 h-16">
      <div className="container mx-auto  flex justify-between items-center h-16">
        ...
        <nav className="hidden md:flex items-center space-x-7">
          ...
          <a href="/itreferral" className="text-gray-600 hover:text-gray-900">
            Employee IT Referral
          </a>
        </nav>
      ...
      >
        <a href="/blogs" className="block text-gray-600 hover:text-gray-900 mb-2">
          Blog
        </a>
        <a href="/free-courses" className="block text-gray-600 hover:text-gray-900 mb-2">
          Free Course
        </a>
        <a href="/jobs" className="block text-gray-600 hover:text-gray-900 mb-2">
          Jobs
        </a>
        <a href="/itreferral" className="block text-gray-600 hover:text-gray-900 mb-4">
          Employee IT Referral
        </a>
        ...
        {session ? (
          ...
          <a href="/jobs" className="block bg-blue-500 text-white px-4 py-2 text-center mt-4 rounded-md hover:bg-blue-600">
            Explore Jobs
          </a>
        )}
      </motion.div>
